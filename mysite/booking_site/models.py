...
class Booking(models.Model):
    ...
    def save(self,*args,**kwargs):
        if self.room_book.room_status == 'забронирован':
            raise ValueError('это комната забронирован')
        elif self.room_book.room_status == 'занят':
            raise ValueError('это комната занят')
        else:
            self.room_book.room_status == 'занят'
